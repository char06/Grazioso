...
class CRUDHandler:
    ...
    def __init__(self, username: str, password: str):
        ...
        # create MongoClient to connect to MongoDB, using authentication with the user created 
    ...
    def create(self, doc_to_insert: dict) -> bool:
        ...
        if doc_to_insert is not None:
            ...
            self.database.insert_one(doc_to_insert)  # data should be dictionary
            inserted = True
    ...
    def findDocs(self, search_criteria: dict):
        ...
        if search_criteria is not None:
            ...
            results = self.database.find(search_criteria)
    ...
    def update(self, look_up_values: dict, new_values: dict):
        ...
        try:
            ...
            # if arguments were not null, then throw the exception 
            if look_up_values is not None and new_values is not None:

                # try updating the document that matches the criteria
                result = self.database.update_one(look_up_values, {"$set": new_values})

                # if the update_one function was successful, then return true
        ...
        # if an update error occurred, return the error so we can see it. 
    ...
    def delete(self, doc_to_delete: dict):
        ...
        try:
            ...
            if doc_to_delete is not None:
                ...
                result = self.database.delete_one(doc_to_delete)
